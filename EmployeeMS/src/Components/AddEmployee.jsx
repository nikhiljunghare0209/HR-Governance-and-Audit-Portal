...
//below useEffect fetches categories from the server when the component mounts.
//this is done using axios to make a GET request to the specified endpoint.
//if the request is successful and the status is true, it updates the category state with the fetched data.
